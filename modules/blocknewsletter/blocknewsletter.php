...
class Blocknewsletter extends Module
{
	...
	{
		if (parent::install() == false || $this->registerHook('header') == false || $this->registerHook('header') == false
...
function hookHeader($params)    {        return $this->display(__FILE__, 'blocknewsletter.tpl');    } 
}
