<?php /* Smarty version Smarty-3.1.14, created on 2014-02-23 19:05:43
         compiled from "/homez.742/maisona/www/maisona/themes/raindrop_yarflam/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1539104078530a3877be5b47-16949798%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f7c1c9d0ce80e756644d8a64be47c631352694e' => 
    array (
      0 => '/homez.742/maisona/www/maisona/themes/raindrop_yarflam/authentication.tpl',
      1 => 1393177385,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1539104078530a3877be5b47-16949798',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530a387885c042_35846884',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530a387885c042_35846884')) {function content_530a387885c042_35846884($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/homez.742/maisona/www/maisona/tools/smarty/plugins/modifier.escape.php';
...
" method="post" id="create-account_form" class="std col-lg-6 col-sm-6">
            <fieldset class="form-horizontal">
                    <div class="frame_wrap frame_wrap_header clearfix">
			<div class="fwh-title"><?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
</div>
                    </div>
                    <div class="form_content frame_wrap frame_wrap_content clearfix">
                            ...
                            <div class="form-group">
                                <label for="email_create" class="col-lg-4 control-label"><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
</label>
                                <div class="col-lg-7">
...
" /><?php }?>
                                    <input type="submit" id="SubmitCreate" name="SubmitCreate" class="btn button" value="<?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
" />
...
" />
	...
	<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'UTF-8', true);?>
" method="post" id="login_form" class="std col-lg-6 col-sm-6">
            <fieldset class="form-horizontal">
                <div class="frame_wrap frame_wrap_header clearfix">
                    <div class="fwh-title"><?php echo smartyTranslate(array('s'=>'Already registered?'),$_smarty_tpl);?>
</div>
                </div>
                    <div class="form_content frame_wrap frame_wrap_content clearfix">
                        <div class="form-group">
...
<?php }?>" class="account_input form-control" />
                        ...
                        <div class="form-group">
                                <label for="passwd" class="col-lg-4 control-label"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
</label>
                                <div class="col-lg-7">
...
<?php }?>" class="account_input form-control" />
                        ...
                        <div class="form-group">
                            <div class="lost_password col-lg-6 col-md-12 col-xs-12"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('password'), ENT_QUOTES, 'UTF-8', true);?>
...
" /><?php }?>
                                    <input type="submit" id="SubmitLogin" name="SubmitLogin" class="btn button" value="<?php echo smartyTranslate(array('s'=>'Authentication'),$_smarty_tpl);?>
" />
                            </p>
                        </div>
                    </div>
...
" method="post" id="new_account_form" class="std clearfix">
            <div class="frame_wrap frame_wrap_header clearfix">
                <div class="fwh-title"><?php echo smartyTranslate(array('s'=>'Instant checkout'),$_smarty_tpl);?>
</div>
            </div>
			...
			<div id="opc_account_form" style="display: block; ">
				<!-- Account -->
                                <div class="form-group required">
                                    <label for="guest_email" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5">
                                        <input type="text" class="form-control" id="guest_email" name="guest_email" value="<?php if (isset($_POST['guest_email'])){?><?php echo $_POST['guest_email'];?>
<?php }?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <span class="col-lg-4 col-md-4 control-label no-pad"><?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
</span>
                                    <div class="col-lg-5 col-md-5">
...
" class="top"><?php echo $_smarty_tpl->tpl_vars['gender']->value->name;?>
					...
					<?php } ?>
                                ...
                                <div class="form-group required">
                                    <label for="customer_firstname" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
                                ...
                                <div class="form-group required">
                                    <label for="customer_lastname" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
                                ...
                                <div class="form-group">
                                    <span class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Date of Birth'),$_smarty_tpl);?>
</span>
                                    <div class="col-lg-5 col-md-5">
...
?>
					<?php if ($_smarty_tpl->tpl_vars['field_name']->value=="company"&&$_smarty_tpl->tpl_vars['b2b_enable']->value){?>
                                                <div class="form-group">
                                                    <label for="company" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
</label>
                                                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
						...
						<div id="vat_number" class="form-group" style="display:none;">
                                                        <label for="vat_number" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'VAT number'),$_smarty_tpl);?>
</label>
                                                        <div class="col-lg-5 col-md-5">
...
<?php }?>" />
						...
						<div class="form-group">
							<label for="dni" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
</label>
							<div class="col-lg-5 col-md-5">
                                                            <input type="text" class="form-control" name="dni" id="dni" value="<?php if (isset($_POST['dni'])){?><?php echo $_POST['dni'];?>
<?php }?>" />
                                                            <span class="help-block"><?php echo smartyTranslate(array('s'=>'DNI / NIF / NIE'),$_smarty_tpl);?>
</span>
                                                        </div>
						</div>
						<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="address1"){?>
                                                <div class="form-group required">
                                                    <label for="address1" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
						...
						<?php $_smarty_tpl->tpl_vars['postCodeExist'] = new Smarty_variable(true, null, 0);?>
                                                <div class="form-group required">
                                                    <label for="postcode" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Zip / Postal Code'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                                    <div class="col-lg-5 col-md-5">
...
<?php }?>" onblur="$('#postcode').val($('#postcode').val().toUpperCase());" />
						...
						<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="city"){?>
                                                <div class="form-group required">
                                                    <label for="city" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'City'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
						...
						<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="Country:name"||$_smarty_tpl->tpl_vars['field_name']->value=="country"){?>
                                                <div class="form-group required">
                                                    <label for="id_country" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                                    <div class="col-lg-5 col-md-5">
...
"<?php if ((isset($_POST['id_country'])&&$_POST['id_country']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
						...
						<?php $_smarty_tpl->tpl_vars['stateExist'] = new Smarty_variable(true, null, 0);?>
                                                <div class="form-group required id_state">
                                                    <label for="id_state" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
				...
				<?php }?>
                                <div class="form-group <?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?>required<?php }?>">
                                    <label for="phone_mobile" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Mobile phone'),$_smarty_tpl);?>
...
?>
					<?php if ($_smarty_tpl->tpl_vars['field_name']->value=="company"&&$_smarty_tpl->tpl_vars['b2b_enable']->value){?>
					<div class="form-group">
                                            <label for="company_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
</label>
                                            <div class="col-lg-5 col-md-5">
...
<?php }?>" />
					...
					<div id="vat_number_block_invoice" class="hidden">
                                            <div class="form-group">
                                                <label for="vat_number_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'VAT number'),$_smarty_tpl);?>
</label>
                                                <div class="col-lg-5 col-md-5">
...
<?php }?>" />
					...
					<?php $_smarty_tpl->tpl_vars['dniExist'] = new Smarty_variable(true, null, 0);?>
					<div class="form-group">
                                            <label for="dni_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
</label>
                                            <div class="col-lg-5 col-md-5">
...
<?php }?>" />
					...
					<div class="form-group required">
                                            <label for="firstname_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                            <div class="col-lg-5 col-md-5">
...
<?php }?>" />
					...
					<div class="form-group required">
                                            <label for="lastname_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                            <div class="col-lg-5 col-md-5">
...
<?php }?>" />
					...
					<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="address1"){?>
					<div class="form-group required">
                                            <label for="address1_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                            <div class="col-lg-5 col-md-5">
...
<?php }?>" />
					...
					<?php $_smarty_tpl->tpl_vars['postCodeExist'] = new Smarty_variable(true, null, 0);?>
                                        <div class="form-group required postcode_invoice">
                                            <label for="postcode_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Zip / Postal Code'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                            <div class="col-lg-5 col-md-5">
...
<?php }?>" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
					...
					<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="city"){?>
					<div class="form-group required">
                                            <label for="city_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'City'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                            <div class="col-lg-5 col-md-5">
...
<?php }?>" />
					...
					<div class="form-group required">
                                            <label for="id_country_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                            <div class="col-lg-5 col-md-5">
...
"<?php if ((isset($_POST['id_country_invoice'])&&$_POST['id_country_invoice']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country_invoice'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])){?> selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['v']->value['name'], 'htmlall', 'UTF-8');?>
					...
					<?php $_smarty_tpl->tpl_vars['stateExist'] = new Smarty_variable(true, null, 0);?>
                                        <div class="form-group required id_state_invoice" style="display:none;">
                                            <label for="id_state_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                            <div class="col-lg-5 col-md-5">
...
<?php }?>" />
					...
					<?php }?>
                                        <div class="form-group <?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?>required<?php }?>">
                                            <label for="phone_mobile_invoice" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Mobile phone'),$_smarty_tpl);?>
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?> <sup>*</sup><?php }?></label>
                                            <div class="col-lg-5 col-md-5">
...
" method="post" id="account-creation_form" class="std">
	...
	<fieldset class="account_creation form-horizontal">
            <div class="frame_wrap frame_wrap_header clearfix">
                <div class="fwh-title"><?php echo smartyTranslate(array('s'=>'Your personal information'),$_smarty_tpl);?>
</div>
            </div>
            <div class="frame_wrap frame_wrap_content">
		<div class="form-group">
                    <label class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
</label>
                    <div class="col-lg-5 col-md-5">
                    <?php  $_smarty_tpl->tpl_vars['gender'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['gender']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
...
<?php }?>" />
		...
		<div class="form-group required">
                    <label for="email" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Email'),$_smarty_tpl);?>
 <sup>*</sup></label>
                    <div class="col-lg-5 col-md-5">
                        <input type="text" class="form-control" id="email" name="email" value="<?php if (isset($_POST['email'])){?><?php echo $_POST['email'];?>
<?php }?>" />
                    </div>
		</div>
		<div class="form-group required">
			<label for="passwd" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
 <sup>*</sup></label>
                        <div class="col-lg-5 col-md-5">
                            <input type="password" class="form-control" name="passwd" id="passwd" />
                            <span class="help-block"><?php echo smartyTranslate(array('s'=>'(Five characters minimum)'),$_smarty_tpl);?>
</span>
                        </div>
		</div>
		<div class="form-group select">
			<label class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Date of Birth'),$_smarty_tpl);?>
</label>
                        <div class="col-lg-5 col-md-5">
...
&nbsp;&nbsp;</option>
	...
	<fieldset class="account_creation form-horizontal">
            <div class="frame_wrap frame_wrap_header clearfix">
		<div class="fwh-title"><?php echo smartyTranslate(array('s'=>'Your company information'),$_smarty_tpl);?>
</div>
            </div>
            <div class="frame_wrap frame_wrap_content">
		<div class="form-group">
...
<?php }?>" />
		...
		<div class="form-group">
                    <label for="siret" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'SIRET'),$_smarty_tpl);?>
</label>
                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
		...
		<div class="form-group">
                    <label for="ape" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'APE'),$_smarty_tpl);?>
</label>
                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
		...
		<div class="form-group">
                    <label for="website" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Website'),$_smarty_tpl);?>
</label>
                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
	...
	<fieldset class="account_creation form-horizontal">
            <div class="frame_wrap frame_wrap_header clearfix">
		<div class="fwh-title"><?php echo smartyTranslate(array('s'=>'Your address'),$_smarty_tpl);?>
</div>
            </div>
            <div class="frame_wrap frame_wrap_content">
		<?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
...
<?php }?>" />
			...
			<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="firstname"){?>
				<div class="form-group required">
                                    <label for="firstname" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
			...
			<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="lastname"){?>
				<div class="form-group required">
                                    <label for="lastname" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
 ...
 <sup>*</sup></label>
                                    <div class="col-lg-5 col-md-5">
                                        <input type="text" class="form-control" name="address1" id="address1" value="<?php if (isset($_POST['address1'])){?><?php echo $_POST['address1'];?>
<?php }?>" />
                                        <span class="help-block"><?php echo smartyTranslate(array('s'=>'Street address, P.O. Box, Company name, etc.'),$_smarty_tpl);?>
</span>
                                    </div>
				</div>
			<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="address2"){?>
				<div class="form-group">
                                    <label for="address2" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Address (Line 2)'),$_smarty_tpl);?>
</label>
                                    <div class="col-lg-5 col-md-5">
                                        <input type="text" class="form-control" name="address2" id="address2" value="<?php if (isset($_POST['address2'])){?><?php echo $_POST['address2'];?>
<?php }?>" />
                                        <span class="help-block"><?php echo smartyTranslate(array('s'=>'Apartment, suite, unit, building, floor, etc...'),$_smarty_tpl);?>
</span>
                                    </div>
				</div>
			<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="postcode"){?>
...
<?php }?>" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
 ...
 <sup>*</sup></label>
		...
		<?php }?>
		<div class="form-group">
                    <label for="other" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Additional information'),$_smarty_tpl);?>
</label>
                    <div class="col-lg-5 col-md-5">
...
<?php }?></textarea>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?>
			<p class="col-lg-offset-4 col-lg-5 col-md-offset-4 col-md-5 help-block required"><?php echo smartyTranslate(array('s'=>'You must register at least one phone number.'),$_smarty_tpl);?>
</p>
		<?php }?>
		<div class="form-group">
                    <label for="phone" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Home phone'),$_smarty_tpl);?>
</label>
                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
                ...
                <div class="form-group required" id="address_alias">
                    <label for="alias" class="col-lg-4 col-md-4 control-label"><?php echo smartyTranslate(array('s'=>'Assign an address alias for future reference.'),$_smarty_tpl);?>
 <sup>*</sup></label>
                    <div class="col-lg-5 col-md-5">
...
<?php }?>" />
	...
	<fieldset class="account_creation dni form-horizontal">
            <div class="frame_wrap frame_wrap_header clearfix">
		<div class="fwh-title"><?php echo smartyTranslate(array('s'=>'Tax identification'),$_smarty_tpl);?>
</div>
            </div>
            <div class="frame_wrap frame_wrap_content">
		<div class="form-group required">
