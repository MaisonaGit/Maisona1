<?php /* Smarty version Smarty-3.1.14, created on 2014-03-15 00:06:35
         compiled from "/homez.742/maisona/www/maisona/themes/raindrop_yarflam/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1907009548531e43ab70b201-57344000%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44c61de8ad17a74c1a26ca26aa589dea771ef73f' => 
    array (
      0 => '/homez.742/maisona/www/maisona/themes/raindrop_yarflam/shopping-cart.tpl',
      1 => 1394804021,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1907009548531e43ab70b201-57344000',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_531e43ac25ac61_50834891',
  'variables' => 
  array (
    'account_created' => 0,
    'empty' => 0,
...
<?php if ($_valid && !is_callable('content_531e43ac25ac61_50834891')) {function content_531e43ac25ac61_50834891($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/homez.742/maisona/www/maisona/tools/smarty/plugins/modifier.escape.php';
...
<div class="frame_wrap frame_wrap_header clearfix">
    <div class="fwh-title"><?php echo smartyTranslate(array('s'=>'Shopping-cart summary'),$_smarty_tpl);?>
</div>
</div>
...
;
	...
	<div style="display:none" id="emptyCartWarning" class="alert"><?php echo smartyTranslate(array('s'=>'Your shopping cart is empty.'),$_smarty_tpl);?>
</div>
...
" class="cart_quantity_input form-control" name="quantity_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_<?php echo $_smarty_tpl->tpl_vars['id_customization']->value;?>
_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
"/>
		...
		<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
			<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
				<tr class="cart_total_price">
					<td class="phone-title" colspan="5"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (tax excl.)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
<?php }?></td>
					<td class="price phone-content" id="total_product" colspan="2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products']->value),$_smarty_tpl);?>
</td>
				</tr>
			<?php }else{ ?>
				<tr class="cart_total_price">
					<td class="phone-title" colspan="5"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (tax incl.)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
<?php }?></td>
					<td class="price phone-content" id="total_product" colspan="2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products_wt']->value),$_smarty_tpl);?>
</td>
				</tr>
			<?php }?>
		<?php }else{ ?>
			<tr class="cart_total_price">
				<td class="phone-title" colspan="5"><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
</td>
				<td class="price phone-content" id="total_product" colspan="2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products']->value),$_smarty_tpl);?>
</td>
			</tr>
...
<?php }?>
			...
			<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&!isset($_smarty_tpl->tpl_vars['virtualCart']->value)){?>
				<tr class="cart_total_delivery" style="<?php if (!isset($_smarty_tpl->tpl_vars['carrier']->value->id)||is_null($_smarty_tpl->tpl_vars['carrier']->value->id)){?>display:none;<?php }?>">
					<td class="phone-title" colspan="5"><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</td>
					<td class="price phone-content" id="total_shipping" colspan="2"><?php echo smartyTranslate(array('s'=>'Free Shipping!'),$_smarty_tpl);?>
</td>
				</tr>
			<?php }else{ ?>
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
						<tr class="cart_total_delivery" <?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0){?> style="display:none;"<?php }?>>
							<td class="phone-title" colspan="5"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (tax excl.)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
<?php }?></td>
							<td class="price phone-content" id="total_shipping" colspan="2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value),$_smarty_tpl);?>
</td>
						</tr>
					<?php }else{ ?>
						<tr class="cart_total_delivery"<?php if ($_smarty_tpl->tpl_vars['total_shipping']->value<=0){?> style="display:none;"<?php }?>>
							<td class="phone-title" colspan="5"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (tax incl.)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
<?php }?></td>
							<td class="price phone-content" id="total_shipping" colspan="2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping']->value),$_smarty_tpl);?>
</td>
						</tr>
					<?php }?>
				<?php }else{ ?>
					<tr class="cart_total_delivery"<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0){?> style="display:none;"<?php }?>>
						<td class="phone-title" colspan="5"><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
</td>
						<td class="price phone-content" id="total_shipping" colspan="2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value),$_smarty_tpl);?>
</td>
					</tr>
			...
			<tr class="cart_total_voucher" <?php if ($_smarty_tpl->tpl_vars['total_discounts']->value==0){?>style="display:none"<?php }?>>
				<td class="phone-title" colspan="5">
				...
				<td class="price-discount price phone-content" id="total_discount">
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['priceDisplay']->value==0){?>
			...
			<tr class="cart_total_price">
				<td class="phone-title" colspan="5"><?php echo smartyTranslate(array('s'=>'Total (tax excl.)'),$_smarty_tpl);?>
</td>
				<td class="price phone-content" id="total_price_without_tax" colspan="2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price_without_tax']->value),$_smarty_tpl);?>
</td>
			</tr>
			<tr class="cart_total_tax">
				<td class="phone-title" colspan="5"><?php echo smartyTranslate(array('s'=>'Total tax'),$_smarty_tpl);?>
</td>
				<td class="price phone-content" id="total_tax" colspan="2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_tax']->value),$_smarty_tpl);?>
</td>
			</tr>
			<?php }?>
			<tr class="cart_voucher">
				<td id="cart_voucher" class="clearfix cart_voucher col-xs-12" colspan="7">
...
?>
					...
					<?php }?>
                                    <div class="cart_voucher_form clearfix">
...
<?php }?>" method="post" id="voucher">
						<fieldset class="form-horizontal">
							<p class="title_block"><label for="discount_name" class="control-label"><?php echo smartyTranslate(array('s'=>'Vouchers'),$_smarty_tpl);?>
</label></p>
							<div class="discount_name_block">
...
" class="btn button exclusive" /></p>
						</fieldset>
					</form>
                                    </div>
                                    <div class="clearfix">
					<?php if ($_smarty_tpl->tpl_vars['displayVouchers']->value){?>
                                            <div class="cart_voucher_text alert alert-info clearfix">
...
<br />
				...
				<?php }?>
                        ...
                        <tr class="cart_total_price">
                            <?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
				<td class="price total_price_container" id="total_price_container" colspan="7">
...
<?php }?>" class="btn button exclusive standard-checkout" title="<?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
</a>
		<?php if (Configuration::get('PS_ALLOW_MULTISHIPPING')){?>
			<a href="<?php if ($_smarty_tpl->tpl_vars['back']->value){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1&amp;back={$back}');?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1');?>
<?php }?>&amp;multi-shipping=1" class="multishipping-button multishipping-checkout btn button exclusive" title="<?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
</a>
		<?php }?>
	<?php }?>
...
<?php }?>" class="button btn" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
