<?php /* Smarty version Smarty-3.1.14, created on 2014-03-06 00:26:43
         compiled from "/homez.742/maisona/www/maisona/themes/raindrop_yarflam/products-comparison.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10581393255317b2b3139003-81772149%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '136f27222b915968adebe837cf3fcf9bf234f5c5' => 
    array (
      0 => '/homez.742/maisona/www/maisona/themes/raindrop_yarflam/products-comparison.tpl',
      1 => 1393177390,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10581393255317b2b3139003-81772149',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5317b2b38b8b48_85171771',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5317b2b38b8b48_85171771')) {function content_5317b2b38b8b48_85171771($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/homez.742/maisona/www/maisona/tools/smarty/plugins/modifier.escape.php';
...
<div class="frame_wrap frame_wrap_header clearfix">
    <div class="fwh-title"><?php echo smartyTranslate(array('s'=>'Product Comparison'),$_smarty_tpl);?>
</div>
</div>

<?php if ($_smarty_tpl->tpl_vars['hasProduct']->value){?>
<div class="products_block frame_wrap frame_wrap_content">
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value->description_short),60,'...');?>
                    ...
                    <div class="comparison_product_infos">
                            <div class="prices_container clearfix">
 ...
 <?php echo smartyTranslate(array('s'=>'per %s','sprintf'=>smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->unity, 'htmlall', 'UTF-8')),$_smarty_tpl);?>
                    ...
                    <?php if ((!$_smarty_tpl->tpl_vars['product']->value->hasAttributes()||(isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&($_smarty_tpl->tpl_vars['add_prod_display']->value==1)))&&$_smarty_tpl->tpl_vars['product']->value->minimal_quantity==1&&$_smarty_tpl->tpl_vars['product']->value->customizable!=2&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
                            <?php if (($_smarty_tpl->tpl_vars['product']->value->quantity>0||$_smarty_tpl->tpl_vars['product']->value->allow_oosp)){?>
                                    <a class="btn exclusive ajax_add_to_cart_button" rel="ajax_id_product_<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
...
"><span></span><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
                            ...
                            <?php }else{ ?>
                                    <span class="btn exclusive"><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
</span>
                            <?php }?>
                    <?php }else{ ?>
                            <div style="height:23px;"></div>
                    <?php }?>
                    <a class="cmp_remove btn button" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('products-comparison',true);?>
...
<div class="frame_wrap frame_wrap_content">
    <div class="alert alert-warning">
        <strong>Warning!</strong> <?php echo smartyTranslate(array('s'=>'There are no products selected for comparison.'),$_smarty_tpl);?>
