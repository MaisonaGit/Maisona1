...
<div id="cart_block" class="block exclusive">
	...
	{/if}
		...
		<p id="cart-buttons">
			...
			<a href="{$link->getPageLink("$order_process", true)|escape:'html'}" id="button_order_cart" class="btn exclusive" title="{l s='Check out' mod='blockcart'}" rel="nofollow"><span></span>{l s='Check out' mod='blockcart'}</a>
		</p>
	</div>
	</div>
</div>
