...
<div id="suppliers_block_left" class="block blocksupplier">
    <div class="frame_wrap frame_wrap_header clearfix">
        <div class="fwh-title">{if $display_link_supplier}<a href="{$link->getPageLink('supplier')}" title="{l s='Suppliers' mod='blocksupplier'}">{/if}{l s='Suppliers' mod='blocksupplier'}{if $display_link_supplier}</a>{/if}</div>
    </div>
