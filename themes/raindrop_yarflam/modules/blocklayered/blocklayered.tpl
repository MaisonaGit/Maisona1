...
<div id="layered_block_left" class="block">
	<div class="frame_wrap frame_wrap_header clearfix">
            <div class="fwh-title">{l s='Filter' mod='blocklayered'}</div>
        </div>
				...
				{foreach from=$filters item=filter}
					{if isset($filter.values)}
						...
						<span class="layered_close"><a href="#" rel="ul_layered_{$filter.type}_{$filter.id_key}">v</a></span>
                                                <ul id="ul_layered_{$filter.type}_{$filter.id_key}" class="ul_layered clearfix">
						{if !isset($filter.slider)}
	...
	<div id="layered_ajax_loader" style="display: none;">
		<div class="loading"><img src="{$img_dir}loading.gif" alt="" /><br /><br />{l s='Loading...' mod='blocklayered'}</div>
	</div>
</div>
{else}
<div id="layered_block_left" class="block">
