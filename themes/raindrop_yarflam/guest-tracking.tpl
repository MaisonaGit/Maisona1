...
<div class="frame_wrap frame_wrap_header clearfix">
    <div class="fwh-title">{l s='Guest Tracking'}</div>
</div>
...
{if isset($order_collection)}
	...
	{else}
                <form method="post" action="{$action|escape:'htmlall':'UTF-8'}#guestToCustomer" id="guest_set_pass" class="std">
			<fieldset class="description_box form-horizontal">
				...
				<div class="form-group guest_input">
					<label class="col-lg-4 col-sm-4 control-label">{l s='Set your password:'}</label>
                                        <div class="col-lg-4 col-sm-4">
                                            <input class="form-control" type="password" name="password" />
                                        </div>
                                        <div class="col-lg-4 col-sm-4">
                                            <button class="btn button exclusive" name="submitTransformGuestToCustomer" type="submit">{l s='Send'}</button>
                                        </div>
				</div>
		...
		<fieldset class="description_box form-horizontal">
			<p>{l s='To track your order, please enter the following information:'}</p>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">{l s='Order Reference:'} </label>
                            <div class="col-lg-3">
				...
				<i>{l s='For example: QIIXJXNUI or QIIXJXNUI#1'}</i>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">{l s='Email'}</label>
                            <div class="col-lg-3">
                        ...
                        <div class="col-lg-3 control-label">
                            <input type="submit" class="btn button exclusive" name="submitGuestTracking" value="{l s='Send'}" />
                        </div>
		</fieldset>
	</form>
{/if}
