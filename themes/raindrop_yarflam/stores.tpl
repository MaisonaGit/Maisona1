...
<div class="frame_wrap frame_wrap_header clearfix">
    <div class="fwh-title">{l s='Our stores'}</div>
</div>
...
{else}
	...
	<p>{l s='Enter a location (e.g. zip/postal code, address, city or country) in order to find the nearest stores.'}</p>
        <div class="form-group">
            ...
            <input type="text" name="location" id="addressInput" class="form-control" value="{l s='Address, zip / postal code, city, state or country'}" onclick="this.value='';" />
	</div>
        <div class="form-group">
            ...
            <span>{$distance_unit}</span>
            <img src="{$img_ps_dir}loader.gif" class="middle" alt="" id="stores_loader" />
	</div>
	<p class="clearfix">
		<input type="button" class="btn button" onclick="searchLocations();" value="{l s='Search'}" style="display: inline;" /> 
	</p>
