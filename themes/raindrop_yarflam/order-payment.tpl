...
{if !$opc}
    <div class="frame_wrap frame_wrap_header clearfix">
        <div class="fwh-title">{l s='Please choose your payment method'}</div>
    </div>
{else}
    <div class="frame_wrap frame_wrap_header clearfix">
        <div class="fwh-title"><span>3</span> {l s='Please choose your payment method'}</div>
    </div>
{/if}
					...
					<tr id="product_{$product.id_product}_{$product.id_product_attribute}_{$id_customization}" class="alternate_item cart_item">
						...
						<td class="cart_quantity">
							...
							{else}
								...
								<input size="2" type="text" value="{$customization.quantity}" class="cart_quantity_input form-control" name="quantity_{$product.id_product}_{$product.id_product_attribute}_{$id_customization}"/>
							{/if}
						</td>
...
{if !$opc}
	<p class="cart_navigation"><a href="{$link->getPageLink('order', true, NULL, "step=2")}" title="{l s='Previous'}" class="btn button">{l s='Previous'}</a></p>
{else}
	</div>
{/if}
</div>
