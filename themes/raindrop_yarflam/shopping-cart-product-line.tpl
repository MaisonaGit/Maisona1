...
<tr id="product_{$product.id_product}_{$product.id_product_attribute}_{if $quantityDisplayed > 0}nocustom{else}0{/if}_{$product.id_address_delivery|intval}{if !empty($product.gift)}_gift{/if}" class="cart_item{if isset($productLast) && $productLast && (!isset($ignoreProductLast) || !$ignoreProductLast)} last_item{elseif isset($productFirst) && $productFirst} first_item{/if}{if isset($customizedDatas.$productId.$productAttributeId) AND $quantityDisplayed == 0} alternate_item{/if} address_{$product.id_address_delivery|intval} {if $odd}odd{else}even{/if}">
	<td class="cart_product clearfix">
            <div class="{bsvisible val=true media='sm'} {bsvisible val=true media='xs'} phone-title">{l s='Product'}</div>
	...
	<td class="cart_description clearfix">
            <div class="{bsvisible val=true media='sm'} {bsvisible val=true media='xs'} phone-title">{l s='Description'}</div>
            <div class="phone-content">
	...
	<td class="cart_ref clearfix">
            <div class="{bsvisible val=true media='sm'} {bsvisible val=true media='xs'} phone-title">{l s='Ref.'}</div>
            <div class="phone-content">
                {if $product.reference}{$product.reference|escape:'htmlall':'UTF-8'}{else}--{/if}</td>
            </div>
	<td class="cart_unit clearfix">
            <div class="{bsvisible val=true media='sm'} {bsvisible val=true media='xs'} phone-title">{l s='Unit price'}</div>
            <div class="phone-content">
	...
	<td class="cart_quantity clearfix"{if isset($customizedDatas.$productId.$productAttributeId) AND $quantityDisplayed == 0}{/if}>
            <div class="{bsvisible val=true media='sm'} {bsvisible val=true media='xs'} phone-title">{l s='Qty'}</div>
            <div class="phone-content">
	...
	<td class="cart_total clearfix">
            <div class="{bsvisible val=true media='sm'} {bsvisible val=true media='xs'} phone-title">{l s='Total'}</div>
            <div class="phone-content">
